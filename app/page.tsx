...
const supporters = [
  ...
  {
    title: "会計に詳しい方",
    description: "会計管理、収支報告、透明性確保について相談できる方",
  },
  {
...
const firstStepItems = [
  ...
  },
  {
    title: "透明な運営体制づくり",
    description:
      "会計管理、個人情報保護、補助対象者の選定方法を整え、透明性のある形で開始します。",
  },
  {
    title: "医療機関相談への接続",
    description:
...
const futureSupportItems = [
  ...
  },
  {
    title: "費用補助への接続",
    description:
      "第0期では少人数を対象に、所定の上限内で原則として接種費用を全額補助することを検討します。",
  },
];
...
const pilotDetails = [
  ...
  },
  {
    ...
    items: [
      ...
      "寄付受付は現在準備中です。第0期の補助は、対象条件、予算上限、医療機関での接種可否確認、領収書・接種記録の確認を踏まえて個別に判断します。",
  ...
  },
  {
    ...
    items: [
      ...
      "0期では、個別支援を確約するのではなく、医療機関での接種可否確認、領収書・接種記録の確認、予算上限などを踏まえて補助可否を判断します。",
    ],
  },
];
...
const activityPrinciples = [
  ...
  },
  {
    title: "小さく始めて実績を積む",
    description:
      "第0期では少人数・上限つきの費用補助から検討し、活動実績を公開しながら、賛同者とともに発展させていきます。",
  },
];
...
function CtaNotice({ inverted = false }: { inverted?: boolean }) {
  return (
    ...
    >
      ...
      <p>
        寄付受付は現在準備中です。第0期の補助は少人数を対象に個別判断します。
      </p>
    </div>
  );
}
      ...
      <section className="bg-gradient-to-b from-white to-sky-50 px-6 py-20 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-6xl">
          <SectionHeading label="Pilot 0" title="0期パイロット募集">
            <p>
              第0期では、MRワクチン・HPVワクチンの接種機会を逃した成人の方から、小規模に相談を受け付けています。まず5名程度を目安に、MR/HPVワクチン接種費用の補助を検討します。補助対象となった場合は、所定の上限内で原則として接種費用を全額補助する予定です。
            </p>
            <p className="mt-4">
              補助は、医療機関で接種可否を確認したうえで、領収書・接種記録を確認して行う予定です。交通費、抗体検査費、診察料、文書料などを補助対象に含めるかは個別に判断します。すべての相談者に補助を約束するものではありません。
            </p>
          </SectionHeading>
      ...
      <section className="px-6 py-20 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-6xl">
          <SectionHeading label="Project Policy" title="活動方針">
            ...
            <p className="mt-4">
              まずは、医学・会計・法務・個人情報管理の面で協力者を募り、透明性のある運営体制を整えます。そのうえで、第0期では少人数を対象に、所定の上限内で原則として接種費用を全額補助することを検討し、活動実績を積み重ねながら、将来的な任意団体化・NPO法人化も視野に入れて進めます。
            </p>
          </SectionHeading>
          <div className="grid gap-5 md:grid-cols-3">
        ...
        <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-7 shadow-sm sm:p-8">
            <div className="space-y-5 text-base leading-8 text-slate-700 sm:text-lg">
              <p>現在、寄付受付は準備中です。</p>
              <p>
                第0期では、まず少人数を対象に、MR/HPVワクチン接種費用を所定の上限内で原則として全額補助することを検討しています。
              </p>
              <p>
                補助は、対象条件、予算上限、医療機関での接種可否確認、領収書・接種記録の確認を踏まえて個別に判断します。すべての相談者に補助を約束するものではありません。
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-7 shadow-sm sm:p-8">
            <div className="space-y-5 text-base leading-8 text-slate-700 sm:text-lg">
              ...
              <p>
                なお、本プロジェクトは個別の医療相談や接種可否の判断を行いません。第0期の補助は、対象条件、予算上限、医療機関での接種可否確認、領収書・接種記録の確認を踏まえて個別に判断します。
              </p>
            </div>
          </div>
        </div>
