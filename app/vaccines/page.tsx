...
const mrItems = [
  ...
  "MRワクチン接種により、95％程度の人が麻しんウイルスと風しんウイルスへの免疫を獲得すると説明されています。",
  "2回接種が非常に重要で、発症予防、重症化予防、周囲への感染拡大リスクの低下につながるとされています。",
  "麻しん対策として、MRワクチンは単独麻しんワクチンと同様の効果が期待されます。",
  "風しん予防にもつながる利点があります。",
  "風しんワクチンは、1回接種で約95％、2回接種で約99％の予防効果があると説明されることがあります。",
  "国内で麻しん報告が増加している状況では、接種歴が不明な成人が医療機関で相談しやすくなることは重要です。",
  "風しんは、将来の妊娠や家族形成に関わる感染症でもあります。",
  "妊娠20週頃までに風しんに感染すると、先天性風しん症候群の原因になることがあります。",
  "妊娠12週までの感染で先天性風しん症候群のリスクが85％、妊娠13〜16週で50％などと説明されています。",
];
...
const faqItems = [
  {
    ...
    items: [
      ...
      "HPVは一般的なウイルスで、性交渉経験のある女性の50〜80％が生涯で一度は感染すると説明されることがあります。",
      "多くのHPV感染は1〜2年以内に自然に消失しますが、一部の持続感染が前がん病変やがんにつながるとされています。",
  ...
  },
  {
    ...
    items: [
      ...
      "27〜45歳では、全員に一律に勧めるというより、今後の感染リスクや本人の希望を踏まえて医療機関で相談して判断する考え方が重要です。",
  ...
  },
  {
    ...
    items: [
      ...
      "2価は主にHPV16・18型を予防し、子宮頸がんの原因の約50〜70％を占める型を防ぐと説明されています。",
      "4価はHPV16・18型に加えて、尖圭コンジローマの原因となるHPV6・11型も予防し、子宮頸がんについては2価と同じく原因の約50〜70％を占める型を防ぐとされています。",
      "9価はさらにHPV31・33・45・52・58型も対象に含み、HPV16/18/31/33/45/52/58型により、子宮頸がんの原因の80〜90％を占める型を防ぐと説明されています。",
...
const references = [
  ...
  {
    label: "厚生労働省 MRワクチン",
    href: "https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/kenkou_iryou/kenkou/kekkaku-kansenshou/yobou-sesshu/vaccine/mr/index.html",
  },
  {
    label: "厚生労働省 風しんQ&A",
  ...
  {
    label: "厚生労働省 風しん",
    href: "https://www.mhlw.go.jp/seisakunitsuite/bunya/kenkou_iryou/kenkou/kekkaku-kansenshou/rubella/",
  },
  {
    label: "国立健康危機管理研究機構 先天性風疹症候群",
    href: "https://id-info.jihs.go.jp/diseases/ha/rubella/020/crs-intro.html",
  },
  {
